#> api:calc/define_const
#
# 計算補助機能のインストール
#
# @within function api:calc/install
...
#> Bit関係
    ...
    scoreboard players set $2^1-1 Const 1
    scoreboard players set $2^2-1 Const 3
    scoreboard players set $2^3-1 Const 7
    scoreboard players set $2^4-1 Const 15
    ...
    scoreboard players set $2^19-1 Const 524287
    ...
    scoreboard players set $2-1 Const 1
    scoreboard players set $4-1 Const 3
    scoreboard players set $8-1 Const 7
    scoreboard players set $16-1 Const 15
    scoreboard players set $32-1 Const 31
    scoreboard players set $64-1 Const 63
    scoreboard players set $128-1 Const 127
    scoreboard players set $256-1 Const 255
    scoreboard players set $512-1 Const 511
    scoreboard players set $1024-1 Const 1023
    scoreboard players set $2048-1 Const 2047
    scoreboard players set $4096-1 Const 4095
    scoreboard players set $8192-1 Const 8191
    scoreboard players set $16384-1 Const 16383
    scoreboard players set $32768-1 Const 32767
    scoreboard players set $65536-1 Const 65535
    scoreboard players set $131072-1 Const 131071
    scoreboard players set $262144-1 Const 262143
    scoreboard players set $524288-1 Const 524287
    scoreboard players set $1048576-1 Const 1048575
    scoreboard players set $2097152-1 Const 2097151
    scoreboard players set $4194304-1 Const 4194303
    scoreboard players set $8388608-1 Const 8388607
    scoreboard players set $16777216-1 Const 16777215
    scoreboard players set $33554432-1 Const 33554431
    scoreboard players set $67108864-1 Const 67108863
    scoreboard players set $134217728-1 Const 134217727
    scoreboard players set $268435456-1 Const 268435455
    scoreboard players set $536870912-1 Const 536870911
    scoreboard players set $1073741824-1 Const 1073741823
    scoreboard players set $2147483648-1 Const 2147483647
