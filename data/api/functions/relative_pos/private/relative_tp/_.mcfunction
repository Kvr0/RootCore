#> api:relative_pos/private/relative_tp/_
...
execute as 0-0-0-0-0 at @s run function api:relative_pos/private/relative_tp/x/_
execute as 0-0-0-0-0 at @s run function api:relative_pos/private/relative_tp/y/_
execute as 0-0-0-0-0 at @s run function api:relative_pos/private/relative_tp/z/_
