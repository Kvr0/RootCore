...
data modify block -30000000 0 43885 Items[0].id set from storage api: Item.id
data modify block -30000000 0 43885 Items[0].Count set from storage api: Item.Count
data modify block -30000000 0 43885 Items[0].tag set from storage api: Item.tag
